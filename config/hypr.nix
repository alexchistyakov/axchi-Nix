  ...
  wayland.windowManager.hyprland = lib.mkForce {
    ...
    settings = {
      ...
      bind = [
        ...
        "${modifier}ALT,N,exec,new-workspace-on-monitor"
        "${modifier}ALT SHIFT,N,exec,move-to-empty-workspace"
        "${modifier}ALT SHIFT,Return,exec,scatter-app-windows"
        "${modifier}ALT SHIFT,SPACE,exec,scatter-app-to-empty-monitors"
        "ALT,Tab,cyclenext"
